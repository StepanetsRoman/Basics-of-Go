...
func main() {
	...
	fmt.Println("Мінімальне значення з (-3, -1, -5):", Min(-3, -1, -5))
	fmt.Println("Мінімальне значення з (10, 10, 10):", Min(10, 10, 10))

	// Тестування функції Average
	fmt.Println("Середнє значення (5, 10, 15):", Average(5, 10, 15))
	fmt.Println("Середнє значення (1, 2, 3):", Average(1, 2, 3))
	fmt.Println("Середнє значення (-5, 0, 5):", Average(-5, 0, 5))

	// Тестування функції SolveLinearEquation
	x1, err1 := SolveLinearEquation(2, -4)
	if err1 != nil {
	...
	x2, err2 := SolveLinearEquation(3, 6)
	if err2 != nil {
	...
	x3, err3 := SolveLinearEquation(0, 5)
	if err3 != nil {
